        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          >
            ...
            <p className="text-text mb-4">
              A modern, responsive resume website created using React, Framer
              Motion, and Tailwind CSS. It has smooth animations and
              minimalistic effects that are pleasing to the eye.
            </p>
          ...
          >
            ...
            <p className="text-text mb-4">
              A responsive landing page showcasing modern design principles and
              SCSS capabilities. Built with a focus on clean design and smooth
              user experience.
            </p>
            <div className="flex gap-2 mb-4 flex-wrap">
              <span className="px-2 py-1 text-sm rounded-full bg-primary bg-opacity-10">
